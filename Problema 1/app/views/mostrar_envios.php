		...
		<div class="col-xs-5">
			<table class="table table-bordered table-striped table-condensed">
				<tr>
					...
					<th colspan="3" class="list-group-item-info">Acción</th>
				</tr>
				<?php foreach ($envios as $valor) :?>
					...
					<td><?=$valor['observaciones'];?></td>
						...
						<td class="btn-info"><a
						href='?accion=Modificar_envio&id=<?=$valor['id']?>'><span
					...
					<td class="btn-success"><a
						href='?accion=Anotar_recepcion&id=<?=$valor['id']?>'><span
							class="glyphicon glyphicon-thumbs-up color"></span></a></td>
						<?php else:?>
						<td></td>
					<td></td>
					<td></td>
...
<p>Número de registros encontrados:<?PHP isset($Contr_listar)? $Contr_listar->NumReg(): $Contr_Buscar->NumRegBuscar($campo,$texto) ?> 
<p>
<p>Se muestran páginas de <?= $TAMANO_PAGINA ?> registros cada una
<p>
<p> Mostrando la página <?= $pagina ?> de <?= $total_paginas?>
<p>
